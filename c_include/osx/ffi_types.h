...
static const int memmove(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___memmove_chk (dest, src, len, __darwin_obsz0 (dest)) : __inline_memmove_chk (dest, src, len));
static __inline void *
__inline_memmove_chk (void *__dest, const void *__src, size_t __len)
{
  return __builtin___memmove_chk (__dest, __src, __len, __builtin_object_size (__dest, 0));
}
static const int memset(dest,val,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___memset_chk (dest, val, len, __darwin_obsz0 (dest)) : __inline_memset_chk (dest, val, len));
static __inline void *
__inline_memset_chk (void *__dest, int __val, size_t __len)
{
  return __builtin___memset_chk (__dest, __val, __len, __builtin_object_size (__dest, 0));
}
static const int strcpy(dest,src) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strcpy_chk (dest, src, __darwin_obsz (dest)) : __inline_strcpy_chk (dest, src));
static __inline char *
__inline_strcpy_chk (char * __dest, const char * __src)
{
  return __builtin___strcpy_chk (__dest, __src, __builtin_object_size (__dest, 2 > 1));
}
static const int stpcpy(dest,src) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___stpcpy_chk (dest, src, __darwin_obsz (dest)) : __inline_stpcpy_chk (dest, src));
static __inline char *
__inline_stpcpy_chk (char *__dest, const char *__src)
{
  return __builtin___stpcpy_chk (__dest, __src, __builtin_object_size (__dest, 2 > 1));
}
static const int stpncpy(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___stpncpy_chk (dest, src, len, __darwin_obsz (dest)) : __inline_stpncpy_chk (dest, src, len));
static __inline char *
...
static const int strncpy(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strncpy_chk (dest, src, len, __darwin_obsz (dest)) : __inline_strncpy_chk (dest, src, len));
static __inline char *
...
static const int strcat(dest,src) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strcat_chk (dest, src, __darwin_obsz (dest)) : __inline_strcat_chk (dest, src));
static __inline char *
__inline_strcat_chk (char * __dest, const char * __src)
{
  return __builtin___strcat_chk (__dest, __src, __builtin_object_size (__dest, 2 > 1));
}
static const int strncat(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strncat_chk (dest, src, len, __darwin_obsz (dest)) : __inline_strncat_chk (dest, src, len));
static __inline char *
