...
static const int __weak = );
static const int __block = );
...
static const int __dead2 = ;
static const int __pure2 = ;
static const int __unused = ;
static const int __used = ;
static const int __deprecated = ;
static const int __unavailable = ;
static const int __printflike(fmtarg,firstvararg) = );
static const int __scanflike(fmtarg,firstvararg) = );
...
static const int __DARWIN_ALIAS(sym) = __DARWIN_SUF_UNIX03);
static const int __DARWIN_ALIAS_C(sym) = __DARWIN_SUF_NON_CANCELABLE __DARWIN_SUF_UNIX03);
static const int __DARWIN_ALIAS_I(sym) = __DARWIN_SUF_64_BIT_INO_T __DARWIN_SUF_UNIX03);
static const int __DARWIN_INODE64(sym) = __DARWIN_SUF_64_BIT_INO_T);
static const int __DARWIN_1050(sym) = __DARWIN_SUF_1050);
static const int __DARWIN_1050ALIAS(sym) = __DARWIN_SUF_1050 __DARWIN_SUF_UNIX03);
static const int __DARWIN_1050ALIAS_C(sym) = __DARWIN_SUF_1050 __DARWIN_SUF_NON_CANCELABLE __DARWIN_SUF_UNIX03);
static const int __DARWIN_1050ALIAS_I(sym) = __DARWIN_SUF_1050 __DARWIN_SUF_64_BIT_INO_T __DARWIN_SUF_UNIX03);
static const int __DARWIN_1050INODE64(sym) = __DARWIN_SUF_1050 __DARWIN_SUF_64_BIT_INO_T);
static const int __DARWIN_EXTSN(sym) = __DARWIN_SUF_EXTSN);
static const int __DARWIN_EXTSN_C(sym) = __DARWIN_SUF_EXTSN __DARWIN_SUF_NON_CANCELABLE);
...
typedef t64_t __darwin_blkcnt_t;
typedef t32_t __darwin_blksize_t;
typedef t32_t __darwin_dev_t;
...
static const int __strfmonlike(fmtarg,firstvararg) = );
static const int __strftimelike(fmtarg) = );
...
static const int __AVAILABILITY_INTERNAL_DEPRECATED = );
static const int __AVAILABILITY_INTERNAL_UNAVAILABLE = );
static const int __AVAILABILITY_INTERNAL_WEAK_IMPORT = );
static const int __AVAILABILITY_INTERNAL_REGULAR = );
...
static const int __DARWIN_NFDBITS = (sizeof(t32_t) * __DARWIN_NBBY);
static const int __DARWIN_howmany(x,y) = ((((x) % (y)) == 0) ? ((x) / (y)) : (((x) / (y)) + 1));
typedef struct fd_set {
 t32_t fds_bits[((((1024) % ((sizeof(t32_t) * 8))) == 0) ? ((1024) / ((sizeof(t32_t) * 8))) : (((1024) / ((sizeof(t32_t) * 8))) + 1))];
} fd_set;
static int
__darwin_fd_isset(int _n, const struct fd_set *_p)
{
 return (_p->fds_bits[_n/(sizeof(t32_t) * 8)] & (1<<(_n % (sizeof(t32_t) * 8))));
}
...
static const int I386_MCONTEXT_SIZE = sizeof(struct mcontext);
...
static const int SIGIOT = SIGABRT;
static const int SIGEMT = 7;
static const int SIGFPE = 8;
static const int SIGKILL = 9;
static const int SIGBUS = 10;
static const int SIGSEGV = 11;
static const int SIGSYS = 12;
static const int SIGPIPE = 13;
static const int SIGALRM = 14;
static const int SIGTERM = 15;
static const int SIGURG = 16;
static const int SIGSTOP = 17;
static const int SIGTSTP = 18;
static const int SIGCONT = 19;
static const int SIGCHLD = 20;
static const int SIGTTIN = 21;
static const int SIGTTOU = 22;
static const int SIGIO = 23;
...
static const int SIGINFO = 29;
static const int SIGUSR1 = 30;
static const int SIGUSR2 = 31;
static const int SIG_DFL = (void (*)(int))0;
static const int SIG_IGN = (void (*)(int))1;
static const int SIG_HOLD = (void (*)(int))5;
static const int SIG_ERR = ((void (*)(int))-1);
static const int _STRUCT_X86_THREAD_STATE32 = struct __darwin_i386_thread_state;
...
static const int _STRUCT_FP_CONTROL = struct __darwin_fp_control;
struct __darwin_fp_control
{
    ...
    __precis :1,
      :2,
    __pc :2,
static const int FP_PREC_24B = 0;
static const int FP_PREC_53B = 2;
static const int FP_PREC_64B = 3;
    __rc :2,
static const int FP_RND_NEAR = 0;
static const int FP_RND_DOWN = 1;
static const int FP_RND_UP = 2;
static const int FP_CHOP = 3;
             :1,
      :3;
};
typedef struct __darwin_fp_control __darwin_fp_control_t;
static const int _STRUCT_FP_STATUS = struct __darwin_fp_status;
...
static const int _STRUCT_MMST_REG = struct __darwin_mmst_reg;
struct __darwin_mmst_reg
{
 char __mmst_reg[10];
 char __mmst_rsrv[6];
};
static const int _STRUCT_XMM_REG = struct __darwin_xmm_reg;
struct __darwin_xmm_reg
{
 char __xmm_reg[16];
};
static const int FP_STATE_BYTES = 512;
static const int _STRUCT_X86_FLOAT_STATE32 = struct __darwin_i386_float_state;
...
static const int _STRUCT_X86_AVX_STATE32 = struct __darwin_i386_avx_state;
...
static const int _STRUCT_X86_EXCEPTION_STATE32 = struct __darwin_i386_exception_state;
...
static const int _STRUCT_X86_DEBUG_STATE32 = struct __darwin_x86_debug_state32;
...
static const int _STRUCT_X86_THREAD_STATE64 = struct __darwin_x86_thread_state64;
...
static const int _STRUCT_X86_FLOAT_STATE64 = struct __darwin_x86_float_state64;
...
static const int _STRUCT_X86_AVX_STATE64 = struct __darwin_x86_avx_state64;
...
static const int _STRUCT_X86_EXCEPTION_STATE64 = struct __darwin_x86_exception_state64;
...
static const int _STRUCT_X86_DEBUG_STATE64 = struct __darwin_x86_debug_state64;
...
static const int _STRUCT_MCONTEXT_AVX32 = struct __darwin_mcontext_avx32;
...
static const int _STRUCT_MCONTEXT64 = struct __darwin_mcontext64;
...
static const int _STRUCT_MCONTEXT_AVX64 = struct __darwin_mcontext_avx64;
...
static const int SIGEV_NONE = 0;
static const int SIGEV_SIGNAL = 1;
static const int SIGEV_THREAD = 3;
struct sigevent {
 int sigev_notify;
 int sigev_signo;
...
static const int ILL_NOOP = 0;
static const int ILL_ILLOPC = 1;
static const int ILL_ILLTRP = 2;
static const int ILL_PRVOPC = 3;
static const int ILL_ILLOPN = 4;
static const int ILL_ILLADR = 5;
static const int ILL_PRVREG = 6;
static const int ILL_COPROC = 7;
static const int ILL_BADSTK = 8;
static const int FPE_NOOP = 0;
static const int FPE_FLTDIV = 1;
static const int FPE_FLTOVF = 2;
static const int FPE_FLTUND = 3;
static const int FPE_FLTRES = 4;
static const int FPE_FLTINV = 5;
static const int FPE_FLTSUB = 6;
static const int FPE_INTDIV = 7;
static const int FPE_INTOVF = 8;
static const int SEGV_NOOP = 0;
static const int SEGV_MAPERR = 1;
static const int SEGV_ACCERR = 2;
static const int BUS_NOOP = 0;
static const int BUS_ADRALN = 1;
static const int BUS_ADRERR = 2;
static const int BUS_OBJERR = 3;
static const int TRAP_BRKPT = 1;
static const int TRAP_TRACE = 2;
static const int CLD_NOOP = 0;
static const int CLD_EXITED = 1;
static const int CLD_KILLED = 2;
static const int CLD_DUMPED = 3;
static const int CLD_TRAPPED = 4;
static const int CLD_STOPPED = 5;
static const int CLD_CONTINUED = 6;
static const int POLL_IN = 1;
static const int POLL_OUT = 2;
static const int POLL_MSG = 3;
static const int POLL_ERR = 4;
static const int POLL_PRI = 5;
static const int POLL_HUP = 6;
union __sigaction_u {
...
static const int sa_handler = __sigaction_u.__sa_handler;
static const int sa_sigaction = __sigaction_u.__sa_sigaction;
static const int SA_ONSTACK = 0x0001;
static const int SA_RESTART = 0x0002;
static const int SA_RESETHAND = 0x0004;
static const int SA_NOCLDSTOP = 0x0008;
static const int SA_NODEFER = 0x0010;
static const int SA_NOCLDWAIT = 0x0020;
static const int SA_SIGINFO = 0x0040;
static const int SA_USERTRAMP = 0x0100;
static const int SA_64REGSET = 0x0200;
static const int SA_USERSPACE_MASK = (SA_ONSTACK | SA_RESTART | SA_RESETHAND | SA_NOCLDSTOP | SA_NODEFER | SA_NOCLDWAIT | SA_SIGINFO);
static const int SIG_BLOCK = 1;
static const int SIG_UNBLOCK = 2;
static const int SIG_SETMASK = 3;
static const int SI_USER = 0x10001;
static const int SI_QUEUE = 0x10002;
static const int SI_TIMER = 0x10003;
static const int SI_ASYNCIO = 0x10004;
static const int SI_MESGQ = 0x10005;
typedef void (*sig_t)(int);
static const int SS_ONSTACK = 0x0001;
static const int SS_DISABLE = 0x0004;
static const int MINSIGSTKSZ = 32768;
static const int SIGSTKSZ = 131072;
struct sigvec {
 void (*sv_handler)(int);
 int sv_mask;
 int sv_flags;
};
static const int SV_ONSTACK = SA_ONSTACK;
static const int SV_INTERRUPT = SA_RESTART;
static const int SV_RESETHAND = SA_RESETHAND;
static const int SV_NODEFER = SA_NODEFER;
static const int SV_NOCLDSTOP = SA_NOCLDSTOP;
static const int SV_SIGINFO = SA_SIGINFO;
...
static const int __DARWIN_OS_INLINE = static __;
static __
__uint16_t
_OSSwapInt16(
    __uint16_t _data
...
static const int _SS_ALIGNSIZE = (sizeof(t64_t));
...
struct cmsghdr;
int inet6ion_space(int);
int inet6ion_init(void *, struct cmsghdr **, int);
int inet6ion_append(struct cmsghdr *, const __uint8_t *,
 int, int);
__uint8_t *inet6ion_alloc(struct cmsghdr *, int, int, int);
int inet6ion_next(const struct cmsghdr *, __uint8_t **);
int inet6ion_find(const struct cmsghdr *, __uint8_t **, int);
...
int inet6_init(void *, socklen_t);
int inet6_append(void *, socklen_t, int, __uint8_t,
     socklen_t, __uint8_t, void **);
int inet6_finish(void *, socklen_t, int);
int inet6_set_val(void *, int, void *, socklen_t);
int inet6_next(void *, socklen_t, int, __uint8_t *,
          socklen_t *, void **);
int inet6_find(void *, socklen_t, int, __uint8_t,
     socklen_t *, void **);
int inet6_get_val(void *, int, void *, socklen_t);
...
int fls(int) );
int flsl(long) );
static const int memcpy(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___memcpy_chk (dest, src, len, __darwin_obsz0 (dest)) : _memcpy_chk (dest, src, len));
static void *
_memcpy_chk (void *__dest, const void *__src, size_t __len)
{
  return __builtin___memcpy_chk (__dest, __src, __len, __builtin_object_size (__dest, 0));
}
static const int memmove(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___memmove_chk (dest, src, len, __darwin_obsz0 (dest)) : _memmove_chk (dest, src, len));
static void *
_memmove_chk (void *__dest, const void *__src, size_t __len)
{
  return __builtin___memmove_chk (__dest, __src, __len, __builtin_object_size (__dest, 0));
}
static const int memset(dest,val,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___memset_chk (dest, val, len, __darwin_obsz0 (dest)) : _memset_chk (dest, val, len));
static void *
_memset_chk (void *__dest, int __val, size_t __len)
{
  return __builtin___memset_chk (__dest, __val, __len, __builtin_object_size (__dest, 0));
}
static const int strcpy(dest,src) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strcpy_chk (dest, src, __darwin_obsz (dest)) : _strcpy_chk (dest, src));
static char *
_strcpy_chk (char * __dest, const char * __src)
{
  return __builtin___strcpy_chk (__dest, __src, __builtin_object_size (__dest, 2 > 1));
}
static const int stpcpy(dest,src) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___stpcpy_chk (dest, src, __darwin_obsz (dest)) : _stpcpy_chk (dest, src));
static char *
_stpcpy_chk (char *__dest, const char *__src)
{
  return __builtin___stpcpy_chk (__dest, __src, __builtin_object_size (__dest, 2 > 1));
}
static const int stpncpy(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___stpncpy_chk (dest, src, len, __darwin_obsz (dest)) : _stpncpy_chk (dest, src, len));
static char *
_stpncpy_chk (char * __dest, const char * __src,
        size_t __len)
{
  return __builtin___stpncpy_chk (__dest, __src, __len, __builtin_object_size (__dest, 2 > 1));
}
static const int strncpy(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strncpy_chk (dest, src, len, __darwin_obsz (dest)) : _strncpy_chk (dest, src, len));
static char *
_strncpy_chk (char * __dest, const char * __src,
        size_t __len)
{
  return __builtin___strncpy_chk (__dest, __src, __len, __builtin_object_size (__dest, 2 > 1));
}
static const int strcat(dest,src) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strcat_chk (dest, src, __darwin_obsz (dest)) : _strcat_chk (dest, src));
static char *
_strcat_chk (char * __dest, const char * __src)
{
  return __builtin___strcat_chk (__dest, __src, __builtin_object_size (__dest, 2 > 1));
}
static const int strncat(dest,src,len) = ((__darwin_obsz0 (dest) != (size_t) -1) ? __builtin___strncat_chk (dest, src, len, __darwin_obsz (dest)) : _strncat_chk (dest, src, len));
static char *
_strncat_chk (char * __dest, const char * __src,
        size_t __len)
{
