# 1 "c_include/windows/original/stdio.h"
...
#pragma pack(pop)
# 25 "c_include/windows/original/stdio.h" 2
/*
 * Currently, all MS C compilers for Win32 platforms default to 8 byte
 * alignment.
 */
...
# 105 "c_include/windows/original/stdio.h"
...
/* Declare _iob[] array */
 FILE * __attribute__((__cdecl__)) __iob_func(void);
/* Define file position type */
# 152 "c_include/windows/original/stdio.h"
...
/* Function prototypes */
 int __attribute__((__cdecl__)) _filbuf( FILE * _File );
 int __attribute__((__cdecl__)) _flsbuf( int _Ch, FILE * _File);
 FILE * __attribute__((__cdecl__)) _fsopen( const char * _Filename, const char * _Mode, int _ShFlag);
 void __attribute__((__cdecl__)) clearerr( FILE * _File);
 errno_t __attribute__((__cdecl__)) clearerr_s( FILE * _File );
 int __attribute__((__cdecl__)) fclose( FILE * _File);
 int __attribute__((__cdecl__)) _fcloseall(void);
 FILE * __attribute__((__cdecl__)) _fdopen( int _FileHandle, const char * _Mode);
 ...
 int __attribute__((__cdecl__)) _fileno( FILE * _File);
 char * __attribute__((__cdecl__)) _tempnam( const char * _DirName, const char * _FilePrefix);
 int __attribute__((__cdecl__)) _flushall(void);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "fopen_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) FILE * __attribute__((__cdecl__)) fopen( const char * _Filename, const char * _Mode);
 errno_t __attribute__((__cdecl__)) fopen_s( FILE ** _File, const char * _Filename, const char * _Mode);
 int __attribute__((__cdecl__)) fprintf( FILE * _File, const char * _Format, ...);
 int __attribute__((__cdecl__)) fprintf_s( FILE * _File, const char * _Format, ...);
 int __attribute__((__cdecl__)) fputc( int _Ch, FILE * _File);
 int __attribute__((__cdecl__)) _fputchar( int _Ch);
 ...
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "freopen_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) FILE * __attribute__((__cdecl__)) freopen( const char * _Filename, const char * _Mode, FILE * _File);
 errno_t __attribute__((__cdecl__)) freopen_s( FILE ** _File, const char * _Filename, const char * _Mode, FILE * _OldFile);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "fscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) fscanf( FILE * _File, const char * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_fscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _fscanf_l( FILE * _File, const char * _Format, _locale_t _Locale, ...);
#pragma warning(push)
#pragma warning(disable:6530)
 int __attribute__((__cdecl__)) fscanf_s( FILE * _File, const char * _Format, ...);
 int __attribute__((__cdecl__)) _fscanf_s_l( FILE * _File, const char * _Format, _locale_t _Locale, ...);
#pragma warning(pop)
 int __attribute__((__cdecl__)) fsetpos( FILE * _File, const fpos_t * _Pos);
 int __attribute__((__cdecl__)) fseek( FILE * _File, long _Offset, int _Origin);
 long __attribute__((__cdecl__)) ftell( FILE * _File);
 int __attribute__((__cdecl__)) _fseeki64( FILE * _File, __int64 _Offset, int _Origin);
 __int64 __attribute__((__cdecl__)) _ftelli64( FILE * _File);
 ...
 char * __attribute__((__cdecl__)) gets_s( char * _Buf, rsize_t _Size);
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "gets_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) gets( char *_Buffer);
 int __attribute__((__cdecl__)) _getw( FILE * _File);
 void __attribute__((__cdecl__)) perror( const char * _ErrMsg);
 int __attribute__((__cdecl__)) _pclose( FILE * _File);
 FILE * __attribute__((__cdecl__)) _popen( const char * _Command, const char * _Mode);
 int __attribute__((__cdecl__)) printf( const char * _Format, ...);
 int __attribute__((__cdecl__)) printf_s( const char * _Format, ...);
 int __attribute__((__cdecl__)) putc( int _Ch, FILE * _File);
 int __attribute__((__cdecl__)) putchar( int _Ch);
 int __attribute__((__cdecl__)) puts( const char * _Str);
 int __attribute__((__cdecl__)) _putw( int _Word, FILE * _File);
 int __attribute__((__cdecl__)) remove( const char * _Filename);
 int __attribute__((__cdecl__)) rename( const char * _OldFilename, const char * _NewFilename);
 int __attribute__((__cdecl__)) _unlink( const char * _Filename);
 void __attribute__((__cdecl__)) rewind( FILE * _File);
 int __attribute__((__cdecl__)) _rmtmp(void);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "scanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) scanf( const char * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_scanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _scanf_l( const char * _Format, _locale_t _Locale, ...);
#pragma warning(push)
#pragma warning(disable:6530)
 int __attribute__((__cdecl__)) scanf_s( const char * _Format, ...);
 int __attribute__((__cdecl__)) _scanf_s_l( const char * _Format, _locale_t _Locale, ...);
#pragma warning(pop)
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "setvbuf" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) void __attribute__((__cdecl__)) setbuf( FILE * _File, char * _Buffer);
 int __attribute__((__cdecl__)) _setmaxstdio( int _Max);
 unsigned int __attribute__((__cdecl__)) _set_output_format( unsigned int _Format);
 unsigned int __attribute__((__cdecl__)) _get_output_format(void);
 int __attribute__((__cdecl__)) setvbuf( FILE * _File, char * _Buf, int _Mode, size_t _Size);
 int __attribute__((__cdecl__)) _snprintf_s( char * _DstBuf, size_t _SizeInBytes, size_t _MaxCount, const char * _Format, ...);
 int __attribute__((__cdecl__)) sprintf_s( char * _DstBuf, size_t _SizeInBytes, const char * _Format, ...);
 int __attribute__((__cdecl__)) _scprintf( const char * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "sscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) sscanf( const char * _Src, const char * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_sscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _sscanf_l( const char * _Src, const char * _Format, _locale_t _Locale, ...);
#pragma warning(push)
#pragma warning(disable:6530)
 int __attribute__((__cdecl__)) sscanf_s( const char * _Src, const char * _Format, ...);
 int __attribute__((__cdecl__)) _sscanf_s_l( const char * _Src, const char * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snscanf( const char * _Src, size_t _MaxCount, const char * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snscanf_l( const char * _Src, size_t _MaxCount, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _snscanf_s( const char * _Src, size_t _MaxCount, const char * _Format, ...);
 int __attribute__((__cdecl__)) _snscanf_s_l( const char * _Src, size_t _MaxCount, const char * _Format, _locale_t _Locale, ...);
#pragma warning(pop)
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "tmpfile_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) FILE * __attribute__((__cdecl__)) tmpfile(void);
 errno_t __attribute__((__cdecl__)) tmpfile_s( FILE ** _File);
 errno_t __attribute__((__cdecl__)) tmpnam_s( char * _Buf, rsize_t _Size);
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "tmpnam_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) tmpnam( char *_Buffer);
 ...
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "vsnprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) vsnprintf( char * _DstBuf, size_t _MaxCount, const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) vsnprintf_s( char * _DstBuf, size_t _DstSize, size_t _MaxCount, const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsnprintf_s( char * _DstBuf, size_t _SizeInBytes, size_t _MaxCount, const char * _Format, va_list _ArgList);
#pragma warning(push)
#pragma warning(disable:4793)
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snprintf( char *_Dest, size_t _Count, const char * _Format, ...); __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_vsnprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _vsnprintf( char *_Dest, size_t _Count, const char * _Format, va_list _Args);
#pragma warning(pop)
 int __attribute__((__cdecl__)) vsprintf_s( char * _DstBuf, size_t _SizeInBytes, const char * _Format, va_list _ArgList);
#pragma warning(push)
#pragma warning(disable:4793)
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "sprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) sprintf( char *_Dest, const char * _Format, ...); __attribute__((deprecated("This function or variable may be unsafe. Consider using " "vsprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) vsprintf( char *_Dest, const char * _Format, va_list _Args);
#pragma warning(pop)
 int __attribute__((__cdecl__)) _vscprintf( const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _snprintf_c( char * _DstBuf, size_t _MaxCount, const char * _Format, ...);
 int __attribute__((__cdecl__)) _vsnprintf_c( char *_DstBuf, size_t _MaxCount, const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _fprintf_p( FILE * _File, const char * _Format, ...);
 int __attribute__((__cdecl__)) _printf_p( const char * _Format, ...);
 int __attribute__((__cdecl__)) _sprintf_p( char * _Dst, size_t _MaxCount, const char * _Format, ...);
 int __attribute__((__cdecl__)) _vfprintf_p( FILE * _File, const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _vprintf_p( const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsprintf_p( char * _Dst, size_t _MaxCount, const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _scprintf_p( const char * _Format, ...);
 int __attribute__((__cdecl__)) _vscprintf_p( const char * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _set_printf_count_output( int _Value);
 int __attribute__((__cdecl__)) _get_printf_count_output(void);
 int __attribute__((__cdecl__)) _printf_l( const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _printf_p_l( const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _printf_s_l( const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vprintf_l( const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vprintf_p_l( const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vprintf_s_l( const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _fprintf_l( FILE * _File, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _fprintf_p_l( FILE * _File, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _fprintf_s_l( FILE * _File, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vfprintf_l( FILE * _File, const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vfprintf_p_l( FILE * _File, const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vfprintf_s_l( FILE * _File, const char * _Format, _locale_t _Locale, va_list _ArgList);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_sprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _sprintf_l( char * _DstBuf, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _sprintf_p_l( char * _DstBuf, size_t _MaxCount, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _sprintf_s_l( char * _DstBuf, size_t _DstSize, const char * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_vsprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _vsprintf_l( char * _DstBuf, const char * _Format, _locale_t, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsprintf_p_l( char * _DstBuf, size_t _MaxCount, const char* _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsprintf_s_l( char * _DstBuf, size_t _DstSize, const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _scprintf_l( const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _scprintf_p_l( const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vscprintf_l( const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vscprintf_p_l( const char * _Format, _locale_t _Locale, va_list _ArgList);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snprintf_l( char * _DstBuf, size_t _MaxCount, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _snprintf_c_l( char * _DstBuf, size_t _MaxCount, const char * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _snprintf_s_l( char * _DstBuf, size_t _DstSize, size_t _MaxCount, const char * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_vsnprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _vsnprintf_l( char * _DstBuf, size_t _MaxCount, const char * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsnprintf_c_l( char * _DstBuf, size_t _MaxCount, const char *, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsnprintf_s_l( char * _DstBuf, size_t _DstSize, size_t _MaxCount, const char* _Format, _locale_t _Locale, va_list _ArgList);
/* wide function prototypes, also declared in wchar.h  */
static const int WEOF = (wint_t)(0xFFFF);
 FILE * __attribute__((__cdecl__)) _wfsopen( const wchar_t * _Filename, const wchar_t * _Mode, int _ShFlag);
 wint_t __attribute__((__cdecl__)) fgetwc( FILE * _File);
 wint_t __attribute__((__cdecl__)) _fgetwchar(void);
 wint_t __attribute__((__cdecl__)) fputwc( wchar_t _Ch, FILE * _File);
 wint_t __attribute__((__cdecl__)) _fputwchar( wchar_t _Ch);
 ...
 wchar_t * __attribute__((__cdecl__)) _getws_s( wchar_t * _Str, size_t _SizeInWords);
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_getws_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _getws( wchar_t *_String);
 int __attribute__((__cdecl__)) _putws( const wchar_t * _Str);
 ...
 int __attribute__((__cdecl__)) _scwprintf( const wchar_t * _Format, ...);
 ...
 int __attribute__((__cdecl__)) _swprintf_c( wchar_t * _DstBuf, size_t _SizeInWords, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _vswprintf_c( wchar_t * _DstBuf, size_t _SizeInWords, const wchar_t * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _snwprintf_s( wchar_t * _DstBuf, size_t _SizeInWords, size_t _MaxCount, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _vsnwprintf_s( wchar_t * _DstBuf, size_t _SizeInWords, size_t _MaxCount, const wchar_t * _Format, va_list _ArgList);
#pragma warning(push)
#pragma warning(disable:4793)
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snwprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snwprintf( wchar_t *_Dest, size_t _Count, const wchar_t * _Format, ...); __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_vsnwprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _vsnwprintf( wchar_t *_Dest, size_t _Count, const wchar_t * _Format, va_list _Args);
#pragma warning(pop)
 int __attribute__((__cdecl__)) _fwprintf_p( FILE * _File, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _wprintf_p( const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _vfwprintf_p( FILE * _File, const wchar_t * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _vwprintf_p( const wchar_t * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _swprintf_p( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _vswprintf_p( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _scwprintf_p( const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _vscwprintf_p( const wchar_t * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _wprintf_l( const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _wprintf_p_l( const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _wprintf_s_l( const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vwprintf_l( const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vwprintf_p_l( const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vwprintf_s_l( const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _fwprintf_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _fwprintf_p_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _fwprintf_s_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vfwprintf_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vfwprintf_p_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vfwprintf_s_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _swprintf_c_l( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _swprintf_p_l( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _swprintf_s_l( wchar_t * _DstBuf, size_t _DstSize, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vswprintf_c_l( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vswprintf_p_l( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vswprintf_s_l( wchar_t * _DstBuf, size_t _DstSize, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _scwprintf_l( const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _scwprintf_p_l( const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _vscwprintf_p_l( const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snwprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snwprintf_l( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _snwprintf_s_l( wchar_t * _DstBuf, size_t _DstSize, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_vsnwprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _vsnwprintf_l( wchar_t * _DstBuf, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 int __attribute__((__cdecl__)) _vsnwprintf_s_l( wchar_t * _DstBuf, size_t _DstSize, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
...
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_swprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) __attribute__((deprecated("swprintf has been changed to conform with the ISO C standard, adding an extra character count parameter. To use traditional Microsoft swprintf, set _CRT_NON_CONFORMING_SWPRINTFS."))) int __attribute__((__cdecl__)) _swprintf( wchar_t *_Dest, const wchar_t * _Format, ...); __attribute__((deprecated("This function or variable may be unsafe. Consider using " "vswprintf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) __attribute__((deprecated("swprintf has been changed to conform with the ISO C standard, adding an extra character count parameter. To use traditional Microsoft swprintf, set _CRT_NON_CONFORMING_SWPRINTFS."))) int __attribute__((__cdecl__)) _vswprintf( wchar_t *_Dest, const wchar_t * _Format, va_list _Args);
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "__swprintf_l_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) __attribute__((deprecated("swprintf has been changed to conform with the ISO C standard, adding an extra character count parameter. To use traditional Microsoft swprintf, set _CRT_NON_CONFORMING_SWPRINTFS."))) int __attribute__((__cdecl__)) __swprintf_l( wchar_t *_Dest, const wchar_t * _Format, _locale_t _Plocinfo, ...); __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_vswprintf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) __attribute__((deprecated("swprintf has been changed to conform with the ISO C standard, adding an extra character count parameter. To use traditional Microsoft swprintf, set _CRT_NON_CONFORMING_SWPRINTFS."))) int __attribute__((__cdecl__)) __vswprintf_l( wchar_t *_Dest, const wchar_t * _Format, _locale_t _Plocinfo, va_list _Args);
#pragma warning(pop)
# 1 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/swprintf.inl" 1
/***
...
*
****/
# 13 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/swprintf.inl"
# 25 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/swprintf.inl"
# 34 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/swprintf.inl"
#pragma warning( push )
...
static __inline int __attribute__((__cdecl__)) vswprintf(wchar_t * _String, size_t _Count, const wchar_t * _Format, va_list _Ap)
{
...
#pragma warning( push )
#pragma warning( disable : 4412 )
static __inline int __attribute__((__cdecl__)) _vswprintf_l(wchar_t * _String, size_t _Count, const wchar_t * _Format, _locale_t _Plocinfo, va_list _Ap)
{
    return _vswprintf_c_l(_String, _Count, _Format, _Plocinfo, _Ap);
}
#pragma warning( pop )
# 554 "c_include/windows/original/stdio.h" 2
# 570 "c_include/windows/original/stdio.h"
 wchar_t * __attribute__((__cdecl__)) _wtempnam( const wchar_t * _Directory, const wchar_t * _FilePrefix);
 int __attribute__((__cdecl__)) _vscwprintf( const wchar_t * _Format, va_list _ArgList);
 int __attribute__((__cdecl__)) _vscwprintf_l( const wchar_t * _Format, _locale_t _Locale, va_list _ArgList);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "fwscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) fwscanf( FILE * _File, const wchar_t * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_fwscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _fwscanf_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, ...);
#pragma warning(push)
#pragma warning(disable:6530)
 int __attribute__((__cdecl__)) fwscanf_s( FILE * _File, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _fwscanf_s_l( FILE * _File, const wchar_t * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "swscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) swscanf( const wchar_t * _Src, const wchar_t * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_swscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _swscanf_l( const wchar_t * _Src, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) swscanf_s( const wchar_t *_Src, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _swscanf_s_l( const wchar_t * _Src, const wchar_t * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snwscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snwscanf( const wchar_t * _Src, size_t _MaxCount, const wchar_t * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_snwscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _snwscanf_l( const wchar_t * _Src, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) _snwscanf_s( const wchar_t * _Src, size_t _MaxCount, const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _snwscanf_s_l( const wchar_t * _Src, size_t _MaxCount, const wchar_t * _Format, _locale_t _Locale, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "wscanf_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) wscanf( const wchar_t * _Format, ...);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wscanf_s_l" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int __attribute__((__cdecl__)) _wscanf_l( const wchar_t * _Format, _locale_t _Locale, ...);
 int __attribute__((__cdecl__)) wscanf_s( const wchar_t * _Format, ...);
 int __attribute__((__cdecl__)) _wscanf_s_l( const wchar_t * _Format, _locale_t _Locale, ...);
#pragma warning(pop)
 FILE * __attribute__((__cdecl__)) _wfdopen( int _FileHandle , const wchar_t * _Mode);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wfopen_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) FILE * __attribute__((__cdecl__)) _wfopen( const wchar_t * _Filename, const wchar_t * _Mode);
 errno_t __attribute__((__cdecl__)) _wfopen_s( FILE ** _File, const wchar_t * _Filename, const wchar_t * _Mode);
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wfreopen_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) FILE * __attribute__((__cdecl__)) _wfreopen( const wchar_t * _Filename, const wchar_t * _Mode, FILE * _OldFile);
 errno_t __attribute__((__cdecl__)) _wfreopen_s( FILE ** _File, const wchar_t * _Filename, const wchar_t * _Mode, FILE * _OldFile);
 void __attribute__((__cdecl__)) _wperror( const wchar_t * _ErrMsg);
 FILE * __attribute__((__cdecl__)) _wpopen( const wchar_t *_Command, const wchar_t * _Mode);
 int __attribute__((__cdecl__)) _wremove( const wchar_t * _Filename);
 errno_t __attribute__((__cdecl__)) _wtmpnam_s( wchar_t * _DstBuf, size_t _SizeInWords);
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wtmpnam_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _wtmpnam( wchar_t *_Buffer);
 wint_t __attribute__((__cdecl__)) _fgetwc_nolock( FILE * _File);
 wint_t __attribute__((__cdecl__)) _fputwc_nolock( wchar_t _Ch, FILE * _File);
 wint_t __attribute__((__cdecl__)) _ungetwc_nolock( wint_t _Ch, FILE * _File);
...
/* Macro definitions */
# 670 "c_include/windows/original/stdio.h"
...
static const int _putwchar_nolock(_c) = _putwc_nolock((_c),stdout);
 void __attribute__((__cdecl__)) _lock_file( FILE * _File);
 void __attribute__((__cdecl__)) _unlock_file( FILE * _File);
 int __attribute__((__cdecl__)) _fclose_nolock( FILE * _File);
 int __attribute__((__cdecl__)) _fflush_nolock( FILE * _File);
 size_t __attribute__((__cdecl__)) _fread_nolock( void * _DstBuf, size_t _ElementSize, size_t _Count, FILE * _File);
 size_t __attribute__((__cdecl__)) _fread_nolock_s( void * _DstBuf, size_t _DstSize, size_t _ElementSize, size_t _Count, FILE * _File);
 int __attribute__((__cdecl__)) _fseek_nolock( FILE * _File, long _Offset, int _Origin);
 long __attribute__((__cdecl__)) _ftell_nolock( FILE * _File);
 int __attribute__((__cdecl__)) _fseeki64_nolock( FILE * _File, __int64 _Offset, int _Origin);
 __int64 __attribute__((__cdecl__)) _ftelli64_nolock( FILE * _File);
 size_t __attribute__((__cdecl__)) _fwrite_nolock( const void * _DstBuf, size_t _Size, size_t _Count, FILE * _File);
 int __attribute__((__cdecl__)) _ungetc_nolock( int _Ch, FILE * _File);
# 740 "c_include/windows/original/stdio.h"
#pragma pack(pop)
