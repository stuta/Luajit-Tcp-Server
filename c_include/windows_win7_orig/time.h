# 1 "c_include/windows/original/time.h"
#define __STDC__ 1
# 1 "c_include/windows/original/time.h"
...
#pragma pack(pop)
# 26 "c_include/windows/original/time.h" 2
 ...
 */
#pragma pack(push,_CRT_PACKING)
# 51 "c_include/windows/original/time.h"
/* Define _CRTIMP */
# 86 "c_include/windows/original/time.h"
typedef long clock_t;
#define _CLOCK_T_DEFINED 
# 99 "c_include/windows/original/time.h"
...
/* non-zero if daylight savings time is used */
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_get_daylight" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) int* __attribute__((__cdecl__)) __daylight(void);
#define _daylight (*__daylight())

/* offset for Daylight Saving Time */
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_get_dstbias" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) long* __attribute__((__cdecl__)) __dstbias(void);
#define _dstbias (*__dstbias())

/* difference in seconds between GMT and local time */
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_get_timezone" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) long* __attribute__((__cdecl__)) __timezone(void);
#define _timezone (*__timezone())

/* standard/daylight savings time zone names */
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_get_tzname" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char ** __attribute__((__cdecl__)) __tzname(void);
#define _tzname (__tzname())

 errno_t __attribute__((__cdecl__)) _get_daylight( int * _Daylight);
 errno_t __attribute__((__cdecl__)) _get_dstbias( long * _Daylight_savings_bias);
 errno_t __attribute__((__cdecl__)) _get_timezone( long * _Timezone);
 errno_t __attribute__((__cdecl__)) _get_tzname( size_t *_ReturnValue, char *_Buffer, size_t _SizeInBytes, int _Index);


/* Function prototypes */
 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "asctime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) asctime( const struct tm * _Tm);

 errno_t __attribute__((__cdecl__)) asctime_s( char *_Buf, size_t _SizeInBytes, const struct tm * _Tm);



__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_ctime32_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) _ctime32( const __time32_t * _Time);
 errno_t __attribute__((__cdecl__)) _ctime32_s( char *_Buf, size_t _SizeInBytes, const __time32_t *_Time);


 clock_t __attribute__((__cdecl__)) clock(void);
 double __attribute__((__cdecl__)) _difftime32( __time32_t _Time1, __time32_t _Time2);

 __attribute__((deprecated("This function or variable may be unsafe. Consider using " "_gmtime32_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) struct tm * __attribute__((__cdecl__)) _gmtime32( const __time32_t * _Time);
 errno_t __attribute__((__cdecl__)) _gmtime32_s( struct tm *_Tm, const __time32_t * _Time);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_localtime32_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) struct tm * __attribute__((__cdecl__)) _localtime32( const __time32_t * _Time);
 errno_t __attribute__((__cdecl__)) _localtime32_s( struct tm *_Tm, const __time32_t * _Time);

 size_t __attribute__((__cdecl__)) strftime( char * _Buf, size_t _SizeInBytes, const char * _Format, const struct tm * _Tm);
 size_t __attribute__((__cdecl__)) _strftime_l( char *_Buf, size_t _Max_size, const char * _Format, const struct tm *_Tm, _locale_t _Locale);

 errno_t __attribute__((__cdecl__)) _strdate_s( char *_Buf, size_t _SizeInBytes);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_strdate_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) _strdate( char *_Buffer);

 errno_t __attribute__((__cdecl__)) _strtime_s( char *_Buf , size_t _SizeInBytes);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_strtime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) _strtime( char *_Buffer);
...
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_ctime64_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) char * __attribute__((__cdecl__)) _ctime64( const __time64_t * _Time);
 errno_t __attribute__((__cdecl__)) _ctime64_s( char *_Buf, size_t _SizeInBytes, const __time64_t * _Time);


__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_gmtime64_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) struct tm * __attribute__((__cdecl__)) _gmtime64( const __time64_t * _Time);
 errno_t __attribute__((__cdecl__)) _gmtime64_s( struct tm *_Tm, const __time64_t *_Time);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_localtime64_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) struct tm * __attribute__((__cdecl__)) _localtime64( const __time64_t * _Time);
 errno_t __attribute__((__cdecl__)) _localtime64_s( struct tm *_Tm, const __time64_t *_Time);

 __time64_t __attribute__((__cdecl__)) _mktime64( struct tm * _Tm);
 __time64_t __attribute__((__cdecl__)) _mkgmtime64( struct tm * _Tm);
 __time64_t __attribute__((__cdecl__)) _time64( __time64_t * _Time);

/* The Win32 API GetLocalTime and SetLocalTime should be used instead. */
__attribute__((deprecated("This function or variable has been superceded by newer library or operating system functionality. Consider using " "GetLocalTime" " instead. See online help for details."))) unsigned __attribute__((__cdecl__)) _getsystime( struct tm * _Tm);
__attribute__((deprecated("This function or variable has been superceded by newer library or operating system functionality. Consider using " "SetLocalTime" " instead. See online help for details."))) unsigned __attribute__((__cdecl__)) _setsystime( struct tm * _Tm, unsigned _MilliSec);
# 224 "c_include/windows/original/time.h"
/* wide function prototypes, also declared in wchar.h */

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wasctime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _wasctime( const struct tm * _Tm);
 errno_t __attribute__((__cdecl__)) _wasctime_s( wchar_t *_Buf, size_t _SizeInWords, const struct tm * _Tm);


__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wctime32_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _wctime32( const __time32_t *_Time);
 errno_t __attribute__((__cdecl__)) _wctime32_s( wchar_t* _Buf, size_t _SizeInWords, const __time32_t * _Time);


 size_t __attribute__((__cdecl__)) wcsftime( wchar_t * _Buf, size_t _SizeInWords, const wchar_t * _Format, const struct tm * _Tm);
 size_t __attribute__((__cdecl__)) _wcsftime_l( wchar_t * _Buf, size_t _SizeInWords, const wchar_t *_Format, const struct tm *_Tm, _locale_t _Locale);

 errno_t __attribute__((__cdecl__)) _wstrdate_s( wchar_t * _Buf, size_t _SizeInWords);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wstrdate_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _wstrdate( wchar_t *_Buffer);

 errno_t __attribute__((__cdecl__)) _wstrtime_s( wchar_t * _Buf, size_t _SizeInWords);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wstrtime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _wstrtime( wchar_t *_Buffer);

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "_wctime64_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) wchar_t * __attribute__((__cdecl__)) _wctime64( const __time64_t * _Time);
 errno_t __attribute__((__cdecl__)) _wctime64_s( wchar_t* _Buf, size_t _SizeInWords, const __time64_t *_Time);



# 1 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/wtime.inl" 1
/***
...
****/
# 13 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/wtime.inl"
       
# 24 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/wtime.inl"
#define _INC_WTIME_INL 


#pragma warning(push)
#pragma warning(disable:4996)
# 44 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/wtime.inl"
static __inline wchar_t * __attribute__((__cdecl__)) _wctime(const time_t * _Time)
{
#pragma warning( push )
#pragma warning( disable : 4996 )
...
static __inline errno_t __attribute__((__cdecl__)) _wctime_s(wchar_t *_Buffer, size_t _SizeInWords, const time_t * _Time)
{
...
#pragma warning(pop)
# 251 "c_include/windows/original/time.h" 2
...
# 1 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/time.inl" 1
/***
...
****/
# 13 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/time.inl"
       
# 24 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/time.inl"
#define _INC_TIME_INL 
# 82 "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/include/time.inl"
static __inline double __attribute__((__cdecl__)) difftime(time_t _Time1, time_t _Time2)
{
    return _difftime64(_Time1,_Time2);
}
__attribute__((deprecated("This function or variable may be unsafe. Consider using " "ctime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) static __inline char * __attribute__((__cdecl__)) ctime(const time_t * _Time)
{
#pragma warning( push )
#pragma warning( disable : 4996 )
...
static __inline errno_t __attribute__((__cdecl__)) ctime_s(char *_Buffer, size_t _SizeInBytes, const time_t * _Time)
{
    return _ctime64_s(_Buffer, _SizeInBytes, _Time);
}

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "gmtime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) static __inline struct tm * __attribute__((__cdecl__)) gmtime(const time_t * _Time)
{
#pragma warning( push )
#pragma warning( disable : 4996 )
...
static __inline errno_t __attribute__((__cdecl__)) gmtime_s(struct tm * _Tm, const time_t * _Time)
{
    return _gmtime64_s(_Tm, _Time);
}

__attribute__((deprecated("This function or variable may be unsafe. Consider using " "localtime_s" " instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details."))) static __inline struct tm * __attribute__((__cdecl__)) localtime(const time_t * _Time)
{
#pragma warning( push )
#pragma warning( disable : 4996 )
...
static __inline errno_t __attribute__((__cdecl__)) localtime_s(struct tm * _Tm, const time_t * _Time)
{
    return _localtime64_s(_Tm, _Time);
}
static __inline time_t __attribute__((__cdecl__)) mktime(struct tm * _Tm)
{
    return _mktime64(_Tm);
}
static __inline time_t __attribute__((__cdecl__)) _mkgmtime(struct tm * _Tm)
{
    return _mkgmtime64(_Tm);
}
static __inline time_t __attribute__((__cdecl__)) time(time_t * _Time)
{
    return _time64(_Time);
}
# 258 "c_include/windows/original/time.h" 2
# 286 "c_include/windows/original/time.h"
#pragma pack(pop)
